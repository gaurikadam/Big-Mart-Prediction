...
# Read text file
Train_Base = read.table("C:/Users/Tyson/Desktop/Big-Mart-Sales/Train.csv",header = TRUE , sep = ",")
Test_Base  = read.table("C:/Users/Tyson/Desktop/Big-Mart-Sales/Test.csv",header = TRUE , sep = ",")
Sub_Base = read.table("C:/Users/Tyson/Desktop/Big-Mart-Sales/sample.csv",header = TRUE , sep = ",")
